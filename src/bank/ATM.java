...
public class ATM {
    ...
    private static volatile boolean isAvailableHours = true;

    public static boolean isOpen () {
        return isAvailableHours;
    }

    public static void openBank(int dayNumber) {
    ...
    public static void main(String[] args) throws InterruptedException {
        Runnable bank = () -> {
            ...
            while(continueSimulation) {
                ...
                i++;
                try {
                    Thread.sleep(new Random().nextInt(400, 2500));
    ...
    public static void menu() {
        ...
        try {
            ...
            System.err.println("\nSimulation of " + dayCount + " day(s) with " + workTimeLength/1000 + "-hour working day started");
            Thread.sleep(50);
        } catch (Exception e) {
